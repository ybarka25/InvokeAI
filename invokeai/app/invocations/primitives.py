...
class CharacterAlignOutput(BaseInvocationOutput):
    ...
    aligned_photo: ImageField = OutputField(description="Photo, aligned to the video if the video was the ratio source.")
    aligned_video: VideoField = OutputField(description="Video, aligned to the photo if the photo was the ratio source.")
