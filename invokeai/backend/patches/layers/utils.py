...
def any_lora_layer_from_state_dict(state_dict: Dict[str, torch.Tensor]) -> BaseLayerPatch:
    ...
    elif "diff" in state_dict or "diff_b" in state_dict:
        # Full a.k.a Diff. Some LyCORIS exports (e.g. bias/norm-only distillation
        # LoRAs) only ship one of the two -- FullLayer tolerates either being absent.
